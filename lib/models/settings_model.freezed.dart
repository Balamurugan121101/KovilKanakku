...
mixin _$SettingsModel {
 ...
 String get templeName; String get address; String get phone; String get receiptPrefix; int get nextReceiptNumber;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsModel&&(identical(other.templeName, templeName) || other.templeName == templeName)&&(identical(other.address, address) || other.address == address)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.receiptPrefix, receiptPrefix) || other.receiptPrefix == receiptPrefix)&&(identical(other.nextReceiptNumber, nextReceiptNumber) || other.nextReceiptNumber == nextReceiptNumber));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,templeName,address,phone,receiptPrefix,nextReceiptNumber);

@override
String toString() {
  return 'SettingsModel(templeName: $templeName, address: $address, phone: $phone, receiptPrefix: $receiptPrefix, nextReceiptNumber: $nextReceiptNumber)';
}
...
@useResult
$Res call({
 String templeName, String address, String phone, String receiptPrefix, int nextReceiptNumber
});
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? templeName = null,Object? address = null,Object? phone = null,Object? receiptPrefix = null,Object? nextReceiptNumber = null,}) {
  return _then(_self.copyWith(
templeName: null == templeName ? _self.templeName : templeName // ignore: cast_nullable_to_non_nullable
as String,address: null == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
as String,phone: null == phone ? _self.phone : phone // ignore: cast_nullable_to_non_nullable
as String,receiptPrefix: null == receiptPrefix ? _self.receiptPrefix : receiptPrefix // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String templeName,  String address,  String phone,  String receiptPrefix,  int nextReceiptNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.templeName,_that.address,_that.phone,_that.receiptPrefix,_that.nextReceiptNumber);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String templeName,  String address,  String phone,  String receiptPrefix,  int nextReceiptNumber)  $default,) {final _that = this;
switch (_that) {
case _SettingsModel():
return $default(_that.templeName,_that.address,_that.phone,_that.receiptPrefix,_that.nextReceiptNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String templeName,  String address,  String phone,  String receiptPrefix,  int nextReceiptNumber)?  $default,) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.templeName,_that.address,_that.phone,_that.receiptPrefix,_that.nextReceiptNumber);case _:
  return null;
...
class _SettingsModel implements SettingsModel {
  const _SettingsModel({required this.templeName, required this.address, required this.phone, required this.receiptPrefix, required this.nextReceiptNumber});
...
@override final  String receiptPrefix;
@override final  int nextReceiptNumber;
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? templeName = null,Object? address = null,Object? phone = null,Object? receiptPrefix = null,Object? nextReceiptNumber = null,}) {
